...
let config = {
  ...
  function addContentToSidebar(marker) {
    ...
    fetch('https://sheets.googleapis.com/v4/spreadsheets/1wXByCklKZl2hsERKD1LHlqOMClP5_aj5-PGMA-C7K8E/values/Hoja 1!A:D?key=AIzaSyBqSKs7DT9oDteBtU5-tgs5t3nxfciLFz0')
    .then(res => res.json())
    .then(datos => {
        tabla(datos.values)
    })
